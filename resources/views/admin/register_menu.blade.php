                      ...
                      <template id="levelMarkup">
                          <li>
                            ...
                            <ul>
                                ...
                                <!--    <button class="addProductSubmit-btn" id="save-menu" type="button">{{ __('Register Menu') }}</button>-->
                                <!--</div>					-->
							</div>
						</div>
					</div>
	...
	$(document).ready(function() {
      ...
      $(".js-treeview").on("click", ".level-remove", function() {
          ...
          if(level == 0){
            ...
            swal({
              text: "Are you about remove this menu!", 
              type: "warning",
            ...
            current_group_id = parseInt($(this).parent().find("#myid").text());
            swal({
              text: "Are you about remove this section!", 
              type: "warning",
              confirmButtonText: "Remove",
              showCancelButton: true
            }).then((result) => {
            ...
            swal({
              text: "Are you about remove this item!", 
              type: "warning",
              confirmButtonText: "Remove",
              showCancelButton: true
            }).then((result) => {
