...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading">{{ __('Edit Restaurant') }} <a class="add-btn"
	...
	<form id="geniusform" action="{{ route('admin-restaruant-update',$data->id) }}" method="POST" enctype="multipart/form-data">
		{{csrf_field()}}
	<div class="row">
		<div class="col-lg-8">
							...
							<div class="body-area">
								...
								<div class="row">
									...
									<div class="col-lg-4">
										...
										<div class="col-lg-12">
											<input type="number" step='0.01' class="input-field" placeholder="{{ __('Enter Delivery Radius') }}" value = "{{ $data->deliveryradius }}"
												name="deliveryradius">
										</div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __('Enter Toast Id') }}"
												name="toast_id" value="{{$data->toast_id}}">
										</div>
                                    </div>
                                    <div class="col-lg-4">
										<div class="col-lg-12">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __('Enter Toast Secret') }}"
												name="toast_secret"  value="{{$data->toast_secret}}">
										</div>
                                    </div>
                                    <div class="col-lg-4">
										<div class="col-lg-12">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __('Enter Toast Token') }}"
												name="toast_token"  value="{{$data->toast_token}}">
										</div>
                                    </div>
                                </div>
                                                ...
                                                @endif
                                        		  <div class="input-group-prepend">
                                        		  	<select class="form-control ordertypeselect" name = "orderTypes[]" style = "height : 35px !important" value="{{$order['orderMethod']}}">
                                        				<option value="E"  {{ strstr($order['orderMethod'],'E') != false ? 'selected' : '' }}>Email</option>
                                        				<option value="F"  {{ strstr($order['orderMethod'],'F') != false ? 'selected' : '' }}>Fax</option>
                                        				<option value="C"  {{ strstr($order['orderMethod'],'C') != false ? 'selected' : '' }}>Call</option>
                                        				<option value="T"  {{ strstr($order['orderMethod'],'T') != false ? 'selected' : '' }}>Text</option>
                                        		    </select>
                                        		  </div>
                                        		  <input type="text" class="form-control orderTypeText" value = "{{$order['orderInfo']}}" name = "orderContent[]" aria-label="Text input with dropdown button"  style = "height : 35px !important">
        ...
        <!--                        <div class="row">-->
								...
								<!--			<div class="left-area">-->
								<!--			    <input type="checkbox" class="check-field"-->
								<!--				name="bakery" style="margin-right:10px!important" {{ $data->bakery=='on'?"checked":"" }}>-->
        ...
        <!--                                <div class="col-lg-12">-->
								<!--			<div class="left-area">-->
								<!--			    <input type="checkbox" class="check-field"-->
								<!--				name="bbq"  style="margin-right:10px!important" {{ $data->bbq=='on'?"checked":"" }}>-->
        ...
        <!--                                <div class="col-lg-12">-->
								<!--			<div class="left-area">-->
								<!--			    <input type="checkbox" class="check-field"-->
								<!--				name="coffee_tea" style="margin-right:10px!important" {{ $data->coffee_tea=='on'?"checked":"" }}>-->
        ...
        <!--                                <div class="col-lg-12">-->
								<!--			<div class="left-area">-->
								<!--			    <input type="checkbox" class="check-field"-->
								<!--				name="comfort_food" style="margin-right:10px!important" {{ $data->comfort_food=='on'?"checked":"" }}>-->
        ...
        <!--                                <div class="col-lg-12">-->
								<!--			<div class="left-area">-->
        <!--                                        <input type="checkbox" class="check-field"-->
								<!--				name="icecream"  style="margin-right:10px!important" {{ $data->icecream=='on'?"checked":"" }}>-->
        ...
        <!--                                        <input type="checkbox" class="check-field"-->
								<!--				name="mexican" style="margin-right:10px!important" {{ $data->mexican=='on'?"checked":"" }}>-->
        ...
        <!--                                <div class="col-lg-12">-->
								<!--			<div class="left-area">-->
        <!--                                        <input type="checkbox" class="check-field"-->
								<!--				name="pizza" style="margin-right:10px!important" {{ $data->pizza=='on'?"checked":"" }}>-->
        ...
        <!--                                <div class="col-lg-12">-->
								<!--			<div class="left-area">-->
        <!--                                        <input type="checkbox" class="check-field"-->
								<!--				name="steakhouse" style="margin-right:10px!important" {{ $data->steakhouse=='on'?"checked":"" }}>-->
