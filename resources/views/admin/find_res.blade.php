						...
						<div class="product-area">
                            <div class="row">
                                ...
                                <div class="col-lg-12" style = "min-height:500px!important">
                                    ...
                                    <form class="search-form" id="geniusform" action = "{{ url('/checkout/admin/restaurant/searchlocation') }}" method = "POST" enctype="multipart/form-data">
                                        ...
                                        <div class="search-option">
                                          ...
                                          <div>
                                            <input name="type" type="radio" value="address" id="type-images" checked="">
                                      ...
                                      @if(session()->get('nothing'))
                                        <h2 class="u-h4 c-opus__title  u-margin-bottom-small" style="text-align: center!important; margin-top:200px!important">No results!</h2>
                                       
                                      @endif
                                      @if(session()->get('found'))
                                        <h2 class="u-h4 c-opus__title  u-margin-bottom-small" style="text-align: center!important; margin-top:150px!important">Found already!</h2>
                                        <div class="" style="text-align:center!important; margin-top: 180px!important">
                                            <a class="add-btn" href="{{ route('admin.view_restaruant', session()->get('found')[0]) }}">
                                                <span class="remove-mobile">{{ __("See it") }}<span>
                                            </a>
                                        </div>
                                      @endif
