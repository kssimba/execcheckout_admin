...
(function($) {
  ...
  $.fn.bannerCropper = function() {
    ...
    var ias = null;
    var jcrop_api;
    var bottom_html = "<input type='file' id='fileInput1'/><canvas id='myCanvas1' style='display:none;'></canvas><div id='modal1'></div><div id='preview1'><div class='buttons'><div class='cancel' id='bannercancel'></div><div class='ok' id='bannerok'></div></div></div>";
    ...
    $(document).ready(function() {
      ...
      $('#fileInput1').change(function(click) {
          
        imageUpload($('#preview1').get(0));
        // Reset input value
        $(this).val("");
      });

      //ok listener
      $('#bannerok').click(function() {
          
        preview1();
        $('#preview1').delay(100).hide();
        $('#modal1').hide();
        jcrop_api.destroy();
        reset();
      });
      ...
      //cancel listener
      $('#bannercancel').click(function(event) {
        $('#preview1').delay(100).hide();
        $('#modal1').hide();
        jcrop_api.destroy();
        reset();
      ...
      if (file.type.match(imageType)) {
        ...
        reader.onload = function(e) {
          ...
          current_image.onload = function() {
            ...
            $("#preview1").css("top", window_height);
            $("#preview1").css("left", window_width);
            $('#preview1').show(500);
    ...
    function preview1() {
      ...
      var kw = imgWidth / $("#preview1").width();
      var kh = imgHeight / $("#preview1").height();
      ...
      $('#banner_photo').val(dataUrl).trigger('change');
