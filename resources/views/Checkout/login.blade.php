      ...
      <div class="row no-gutters overflow-auto">
        <div class="col-md-6">
          <div class="main-banner">
            ...
            <div class="overlay-2 main-padding">
              <img src="assets/img/logo-signin.png" class="img-fluid" alt="logo">
            </div>
        ...
        <div class="col-md-6">
          <div class="section-2 user-page main-padding">
            <div class="login-sec">
              <div class="login-box">
                <form action="{{ url('/checkout/signin') }}" method="POST">
                    @csrf
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div class="form-group text-center mb-0"> <a href="/checkout/register">Create your account</a>
                      </div>
                    </div>
                  </div>
                </form>
