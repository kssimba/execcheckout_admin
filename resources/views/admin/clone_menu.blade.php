        ...
        $('#option-modal_done').on('click', function() {
            ...
            if($("#option-modal-input-type").val() > 2){
                if(edit == 1){
                    ...
                    menus[current_menu_id].menu_group[current_group_id].menu_items[current_item_id].menu_item_options[current_option_id].trigger = savedGroup[$("#option-modal-input-type").val()-3].data.trigger;
                ...
                menus[current_menu_id].menu_group[current_group_id].menu_items[current_item_id].menu_item_options.push({
                    ...
                    'trigger':savedGroup[$("#option-modal-input-type").val()-3].data.trigger,
                    'menu_option_options':[],
                    'suboption_count':0,
