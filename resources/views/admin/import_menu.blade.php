...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading">{{ __('Eidt Menu') }} <a class="add-btn"
        ...
        <form id="item-edit-form" class="form-horizontal" method="POST" action="">
          <div class="card text-white bg-dark mb-0">
            ...
            <div class="card-body">
			  ...
			  <div class="form-group" >
                <label class="col-form-label" for="modal-input-calories">Menu Item Calories</label>
                <input type="text" name="modal-input-calories" class="form-control" id="item-modal-input-calories" required>
              </div>
              <div class="form-group" >
                <label class="col-form-label" for="modal-input-heat">Menu Item Heat Index</label>
                <input type="text" name="modal-input-heat" class="form-control" id="item-modal-input-heat" required>
              </div>
              <div class="form-group" >
                <label class="col-form-label" for="modal-input-allergy">Menu Item Allergy Information</label>
                <input type="text" name="modal-input-allergy" class="form-control" id="item-modal-input-allergy" required>
              </div>
              <div class="form-group" >
                <label class="col-form-label" for="modal-input-allergens">Menu Item Allergy Information Allergens</label>
                <input type="text" name="modal-input-allergens" class="form-control" id="item-modal-input-allergens" required>
              </div>
              <div class="form-group" >
                <label class="col-form-label" for="modal-input-special">Menu Special</label>
                <input type="text" name="modal-input-special" class="form-control" id="item-modal-input-special" required>
              </div>
              <div class="form-group" >
                <label class="col-form-label" for="modal-input-taxid">Tax ID</label>
                <input type="text" name="modal-input-taxid" class="form-control" id="item-modal-input-taxid" required>
              </div>
              <div class="form-group" >
                <label class="col-form-label" for="modal-input-taxname">Tax Name</label>
                <input type="text" name="modal-input-taxname" class="form-control" id="item-modal-input-taxname" required>
              </div>
              <div class="form-group" >
                <label class="col-form-label" for="modal-input-taxrate">Tax Rate</label>
                <input type="text" name="modal-input-taxrate" class="form-control" id="item-modal-input-taxrate" required>
              </div>
              <div style= "display:flex; flex-direction:row;">
                  ...
                  <div style="width:50%">
                    <div class="form-group" style= "display:flex; flex-direction:row; align-items: center">
                      ...
                      <div class="form-group" style= "display:flex; flex-direction:row; align-items: center">
                        <input type="checkbox" style = "width:18px; height:18px; margin-right:20px"name="modal-input-default" class="form-control" id="item-modal-input-default" required>
                        <label class="col-form-label" for="modal-input-default">Is Defaults</label>
                      </div>
                  </div>
              </div>
            </div>
	...
	$(document).ready(function() {
        ...
        $('#edit-item-modal').on('show.bs.modal', function() {
            if(edit == 1){
                ...
                menus[current_menu_id].menu_group[current_group_id].menu_items[current_item_id].default=='true'?$("#item-modal-input-default").prop('checked',true):$("#item-modal-input-default").prop('checked',false)
        ...
        $('#item-modal_done').on('click', function() {
            if(edit == 1){
                ...
                menus[current_menu_id].menu_group[current_group_id].description = $("#item-modal-input-description").val();
