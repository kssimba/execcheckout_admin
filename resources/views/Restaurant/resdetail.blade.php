...
<head>
    ...
    <title>foodmart | Restaurant</title>
    <!-- Fav and touch icons -->
...
<body>
    ...
    <div class="page-banner p-relative smoothscroll" id="menu">
        <img src="https://via.placeholder.com/1920x270" class="img-fluid full-width" alt="banner">
        <div class="overlay-2">
            <div class="container">
                <div class="row">
                    <div class="col-6">
                ...
                <div class="col-xl col-lg-4 col-md-4 col-sm-6">
                    <div class="footer-contact">
                        ...
                        <ul>
                            ...
                            <li class="fw-600"><span class="text-light-white">Join our twitter</span> <a href="#" class="text-light-black">@foodmart</a>
                            </li>
                            <li class="fw-600"><span class="text-light-white">Join our instagram</span> <a href="#" class="text-light-black">@foodmart</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="copyright">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="copyright-text"> <span class="text-light-black">© <a href="#" class="text-light-white">Slidesigma</a> - 2020 | All Right Reserved</span>
                    </div>
                </div>
            </div>
        </div>
