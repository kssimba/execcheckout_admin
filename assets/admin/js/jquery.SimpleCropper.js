...
(function($) {
  ...
  $.fn.simpleCropper = function() {
    ...
    var ias = null;
    var jcrop_api;
    var bottom_html = "<input type='file' id='fileInput'/><canvas id='myCanvas' style='display:none;'></canvas><div id='modal'></div><div id='preview'><div class='buttons'><div class='cancel' id='logocancel'></div><div class='ok' id='logook'></div></div></div>";
    ...
    $(document).ready(function() {
      ...
      //cancel listener
      $('#logocancel').click(function(event) {
        $('#preview').delay(100).hide();
        $('#modal').hide();
        jcrop_api.destroy();
        reset();
